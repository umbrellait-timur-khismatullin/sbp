...
class Sbp {
  ...
  static Future<List<String>> getAndroidInstalledByPackageNameBanks(
  ...
  static Future<List<C2bmemberModel>> getIOSInstalledByC2bmembersJsonBanks(
    ...
    final List<String> schemaApplications = c2bmembersModel.c2bmembersModel
        .map((c2bmember) => c2bmember.schema)
        .toList();
    ...
    c2bmembersModelIndex++) {
      ...
      indexInstalledSchema++) {
        if (c2bmembersModel.c2bmembersModel[c2bmembersModelIndex].schema ==
          ...
          c2bmembersInstalled
              .add(c2bmembersModel.c2bmembersModel[c2bmembersModelIndex]);
        }
      }
    }
  ...
  static Future<List<String>> getIOSInstalledBySchemesBanks(
      List<String> schemes) async {
  ...
  static Future<bool> openBankIOS(String url, String schema) async =>
      await _channel.invokeMethod(
        'openBank',
        {
          'url': url,
